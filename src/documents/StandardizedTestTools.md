...
The question consists of two statements, an assertion and a reason. The student must first determine whether each
...
The text match question requires a student to supply an answer to a question or complete a blank within a brief piece of
text, using words, symbols or numbers.
