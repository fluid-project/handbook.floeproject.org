...
* See a <a href="http://build.fluidproject.org/videoPlayer/demos/Mammals.html" rel="nofollow" class="link-external">demo of the current version of Floe Video Player</a>
...
* <a href="http://www.amara.org/en/" rel="nofollow" class="link-external">Amara</a>: a web application (formerly called Universal Subtitles), online community, and subtitles database for subtitling or captioning videos
* See Floe’s usability and accessibility review on Universal Subtitles:
   * <a href="http://wiki.fluidproject.org/pages/viewpage.action?pageId=29492583" rel="nofollow" class="link-external">Universal Subtitles user testing usability report</a>
   * <a href="http://wiki.fluidproject.org/pages/viewpage.action?pageId=29492574" rel="nofollow" class="link-external">Universal Subtitles user testing accessibility report</a>
   * <a href="http://wiki.fluidproject.org/pages/viewpage.action?pageId=29491519" rel="nofollow" class="link-external">Universal Subtitles user testing data</a>
...
* For video subtitles, captions, transcripts:
   ...
   * Text style
        * Serif
        * Sans-serif
        * Weighted for dyslexia (e.g., <a href="http://www.dyslexiefont.com/en/dyslexia-font/" rel="nofollow" class="link-external">Dyslexie font</a>)
...
See a <a href="http://build.fluidproject.org/videoPlayer/demos/Mammals.html" rel="nofollow" class="link-external">demo of the current version of the Floe video player</a> (not all features might be implemented)
