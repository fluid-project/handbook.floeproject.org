...
This is especially critical for hackathons trying to tackle social challenges faced by identifiable groups such as people with disabilities, under the principle of <a href="https://en.wikipedia.org/wiki/Nothing_About_Us_Without_Us" target="_blank" class="link-external">*Nothing About Us Without Us*</a>.

> *topics that may need filling in, or may simply distract*
> - how "feminine" subjects are often not qualified or popularized as making/hacking
> - critical discussions of making/hacking
...
* Plan, execute and review in the open; give people opportunity to provide feedback before and after the event or activity.

#### A Note on STEM Diversity

Because hacking and making are strongly conceptually associated with STEM (Science, Technology, Engineering and Math) disciplines, it's not possible to discuss this subject without reference to the widespread work that has gone on to investigate and address the issue of demographic diversity in STEM both academically and <a href="https://www.wired.com/brandlab/2015/05/5-numbers-explain-stem-diversity-matters-us/" target="_blank" class="link-external">in the wider world</a>.
...
We encourage those considering hacking and making in learning contexts to be aware of larger issues of diversity in STEM subjects, workplaces and communities, as these issues have relevance and knock-on effects to the diversity and inclusion of hackathons and hacking.

## Scenarios

The scenarios below offer some examples of how inclusively designed hackathons and hacking activities might operate in practice; they are not comprehensive or prescriptive.
...
- reaching out via Disability Studies programs, Office of Disability Services, community organizations, etc

### Ed-Tech Hackathons and Code Sprints

- specifically propose working on accessibility problems in OERs, LMS, etc

## Tools

The <a href="http://www.prosperity4all.eu/" target="_blank" class="link-external">Prosperity 4All</a> project that Floe
<a href="http://www.prosperity4all.eu/about-p4a/projectpartners/" target="_blank" class="link-external">participates in</a>has supported both the development and cataloguing of numerous tools relevant to inclusive learning through hacking and making. These include:
...
The examples above are only a sample of what is available; more can be found by exploring the <a href="http://dspace.teco.edu/" target="_blank" class="link-external">Developer Space</a>, especially the lists of <a href="http://dspace.teco.edu/en/categories/parts-tools" target="_blank" class="link-external">Parts &amp; Tools</a>.
